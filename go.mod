...
replace github.com/filecoin-project/sector-storage  => github.com/xjrwfilecoin/sector-storage v0.3.3

replace github.com/filecoin-project/storage-fsm  => github.com/xjrwfilecoin/storage-fsm v0.3.1
