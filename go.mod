...
replace github.com/filecoin-project/sector-storage  => github.com/xjrwfilecoin/sector-storage v0.1.3

replace github.com/filecoin-project/storage-fsm  => github.com/xjrwfilecoin/storage-fsm v0.1.0
