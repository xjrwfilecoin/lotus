...
//这个需要改造成一个tcpReader
func (sa SealAgent) ReadPieceFromSealedSector(ctx context.Context, pieceSize uint64, offset uint64, size uint64, ticket []byte, commD []byte) (io.ReadCloser, error) {
