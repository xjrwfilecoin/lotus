...
type WorkerStruct struct {
	Internal struct {
		...
		WorkerAddPiece  func(ctx context.Context, sector abi.SectorID, pieceSizes []abi.UnpaddedPieceSize, newPieceSize abi.UnpaddedPieceSize) (abi.PieceInfo, error)                                              `perm:"admin"`
...
func (w *WorkerStruct) WorkerAddPiece(ctx context.Context, sector abi.SectorID, pieceSizes []abi.UnpaddedPieceSize, newPieceSize abi.UnpaddedPieceSize) (abi.PieceInfo, error) {
	return w.Internal.WorkerAddPiece(ctx, sector, pieceSizes, newPieceSize)
}
